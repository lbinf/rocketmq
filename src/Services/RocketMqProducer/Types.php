...
class CommonMessage {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('CommonMessage');
    if ($this->topic !== null) {
    ...
    if ($this->tags !== null) {
      $xfer += $output->writeFieldBegin('tags', TType::STRING, 2);
...
class DelayMessage {
  ...
  public function __construct($vals=null) {
    if (is_array($vals)) {
      ...
      if (isset($vals['seconds'])) {
        $this->seconds = $vals['seconds'];
      }
      if (isset($vals['key'])) {
        $this->key = $vals['key'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::I64) {
            $xfer += $input->readI64($this->seconds);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('DelayMessage');
    if ($this->topic !== null) {
      $xfer += $output->writeFieldBegin('topic', TType::STRING, 1);
      $xfer += $output->writeString($this->topic);
      $xfer += $output->writeFieldEnd();
    ...
    if ($this->seconds !== null) {
      $xfer += $output->writeFieldBegin('seconds', TType::I64, 4);
      $xfer += $output->writeI64($this->seconds);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->key !== null) {
...
class OrderMessage {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('OrderMessage');
    if ($this->topic !== null) {
      $xfer += $output->writeFieldBegin('topic', TType::STRING, 1);
      $xfer += $output->writeString($this->topic);
      $xfer += $output->writeFieldEnd();
    ...
    if ($this->shardingKey !== null) {
      $xfer += $output->writeFieldBegin('shardingKey', TType::STRING, 5);
